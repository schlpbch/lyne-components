...
| `labelFirst`       | `label-first`        | The name attribute to use for the button                                                                                                        | `string`                                                                                                                                                 | `undefined`             |
| `labelPlacement`   | `label-placement`    | The name attribute to use for the button                                                                                                        | `string`                                                                                                                                                 | `undefined`             |
| `labelSecond`      | `label-second`       | The value attribute to use for the button                                                                                                       | `string`                                                                                                                                                 | `undefined`             |
...
| `valueFirst`       | `value-first`        | The name attribute to use for the button                                                                                                        | `string`                                                                                                                                                 | `undefined`             |
| `valueSecond`      | `value-second`       | The value attribute to use for the button                                                                                                       | `string`                                                                                                                                                 | `undefined`             |
