...
describe('lyne-image', () => {
  it('renders', async () => {
    const {
      ...
      html: `<lyne-image image-src="${images[0]}" />`
    });
          ...
          <mock:shadow-root>
            <figure class="image__figure">
              <div class="image__wrapper">
                <img alt="" class="image__lqip" decoding="auto" height="1000" loading="eager" src="https://cdn.img.sbb.ch/content/dam/internet/lyne/Billetkontrolle.jpg?blur=100&amp;w=100&amp;h=56" width="562">
                <picture>
                  ...
                  <img class="image__img" decoding="auto" height="1000" importance="high" loading="eager" src="https://cdn.img.sbb.ch/content/dam/internet/lyne/Billetkontrolle.jpg" width="562">
                </picture>
              </div>
            </figure>
          </mock:shadow-root>
