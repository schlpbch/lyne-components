...
| `labelLeft`        | `label-left`         | The name attribute to use for the button                                                                                                        | `string`                                                                                                                                                 | `undefined`             |
| `labelRight`       | `label-right`        | The value attribute to use for the button                                                                                                       | `string`                                                                                                                                                 | `undefined`             |
...
| `valueLeft`        | `value-left`         | The name attribute to use for the button                                                                                                        | `string`                                                                                                                                                 | `undefined`             |
| `valueRight`       | `value-right`        | The value attribute to use for the button                                                                                                       | `string`                                                                                                                                                 | `undefined`             |
