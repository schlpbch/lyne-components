...
| ------------------- | ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | -------------- |
| `appearance`        | `appearance`        | Set the desired appearance of the component.                                                                                                                                                                                                                                                                                                                                                       | `"arrival" \| "departure" \| "departure-and-arrival" \| "inter-segment" \| "level-1"` | `'level-1'`    |
...
| `openEnd`           | `open-end`          | If set to true, we will not show a closing dot at the end of the line                                                                                                                                                                                                                                                                                                                              | `boolean`                                                                             | `undefined`    |
| `orientation`       | `orientation`       | Set the desired orientation of the pearl chain.                                                                                                                                                                                                                                                                                                                                                    | `"horizontal" \| "vertical"`                                                          | `'horizontal'` |
